...
class ApiConfig {
  ...
  // Payment endpoints
  static String get paymentUrl => '$baseUrl/users/payment';
  static String get calculatePricingUrl => '$paymentUrl/calculate-pricing';
  static String get createRazorpayOrderUrl => '$paymentUrl/create-razorpay-order';
  static String get verifyRazorpayPaymentUrl => '$paymentUrl/verify-razorpay-payment';
  ...
  static String get razorpayKeyId {
    ...
    if (keyId == null || keyId.isEmpty) {
      return 'rzp_test_RMhVapXjY6vZ9h'; // Replace with your actual test key
    }
    return keyId;
  }
  
  // WebSocket URL
  static String get socketUrl => baseUrlWithoutApi;
